...
//}
//
//// プレビュー用のScore構造体定義（GameViewのScoreと同じ構造）
...
//        ZStack {
//            Color.black.edgesIgnoringSafeArea(.all) // 背景色を暗めに設定
//
//            VStack(spacing: 20) {
//                // 最新の結果（強調表示あり）
//                EnhancedScoreCardView(
//                    score: GameView.Score(id: 1, input: "123", hits: 1, blows: 2),
//                    isLatest: true
//                )
//
//                // 通常の結果
//                EnhancedScoreCardView(
//                    score: GameView.Score(id: 2, input: "456", hits: 0, blows: 1),
//                    isLatest: false
//                )
//
//                // 全部ヒットの結果
//                EnhancedScoreCardView(
//                    score: GameView.Score(id: 3, input: "789", hits: 3, blows: 0),
//                    isLatest: false
//                )
//            }
//            .padding()
